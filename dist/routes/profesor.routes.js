 ...
 */
router.put("/profesor/:id", profesor_controller_1.ProfesorController.updateProfesor);
/**
 * @swagger
 * /profesor/{id}:
 *   delete:
 ...
 *         description: Profesor no encontrado
 */
router.delete("/profesor/:id", profesor_controller_1.ProfesorController.deleteProfesor);
/**
 * @swagger
 * components:
 *   schemas:
