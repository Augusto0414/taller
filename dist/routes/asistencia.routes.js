 ...
 *               $ref: '#/components/schemas/AsistenciaResponse'
 */
router.put("/asistencia/:id", asistencia_controller_1.AsistenciaController.updateAsistencia);
/**
 * @swagger
 * /asistencia/{id}:
 *   delete:
 ...
 */
router.delete("/asistencia/:id", asistencia_controller_1.AsistenciaController.deleteAsistencia);
/**
 * @swagger
 * /asistencia/filter:
 *   get:
 ...
 *                 $ref: '#/components/schemas/AsistenciaResponse'
 */
router.get("/asistencia/filter", asistencia_controller_1.AsistenciaController.filterAsistencias);
/**
 * @swagger
 * components:
 *   schemas:
